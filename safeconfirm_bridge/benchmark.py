...
from safeconfirm_bridge.suites.workspace_external.task_suite import task_suite as workspace_external_task_suite
...
register_suite(workspace_external_task_suite, BENCHMARK_VERSION)
